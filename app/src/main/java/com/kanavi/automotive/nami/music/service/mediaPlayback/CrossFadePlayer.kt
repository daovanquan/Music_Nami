...
import com.kanavi.automotive.nami.music.service.mediaPlayback.AudioFader.Companion.CROSS_FADE_DURATION
import com.kanavi.automotive.nami.music.service.mediaPlayback.AudioFader.Companion.createFadeAnimator
...
class CrossFadePlayer(context: Context) : LocalPlayback(context) {
    ...
    override fun setDataSource(
        ...
        Timber.d("setDataSource: ${song.title} \n songPath: ${song.path} \n Uri: ${song.getUri()} ")
